package com.ozturkurtulus.storingdata
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //SharedPrefences 1-2 veri kaydetmek için ideal bir kaydetme yöntemi
        sharedPreferences = this.getSharedPreferences("com.ozturkurtulus.storingdata",
